...
* Selection is now preserved after edits. Different behaviors implemented for spacebar (insert+shift), delete key (replace with dashes), and backspace (delete left of selection).
